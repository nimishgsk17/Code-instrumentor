...
Output on running on Jugs.cpp (Jugs/Software-testing-case-studies-master/jugs/code/jugs.cpp)
Notice how the shorter functions do not have any instrumented couts inside them. (Eg:void State::setContent(unsigned int value, unsigned int i))
